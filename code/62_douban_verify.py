...
driver.find_element_by_xpath('//*[@id="password"]').send_keys('zhanshen001')
...
ActionChains(driver).move_to_element_with_offset(click_node, xoffset=160, yoffset=0).perform()
